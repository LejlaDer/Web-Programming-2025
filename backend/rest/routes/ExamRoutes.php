...
Flight::route('GET /customers', function(){
    ...
    */
    ...
    Flight::json($examService->get_customers());
});
});
...
Flight::route('GET /customer/meals/@customer_id', function($customer_id){
    ...
    */
    $examService = new ExamService();
    Flight::json($examService->get_meals_by_customer($customer_id));
...
Flight::route('POST /customers/add', function() {
    ...
    */
    ...
    $examService = new ExamService();
    Flight::json($examService->add($data));
});
...
Flight::route('GET /foods/report', function(){
    ...
    */
    ...
    $page_size = Flight::request()->query['page_size'] ?? 10;

    $examService = new ExamService();
    Flight::json($examService->get_food_report($page, $page_size));
});
